"""Entrypoint de FastAPI y gestion del ciclo de vida de la app."""
...
from app.api import health, index, ingest, query, stats
...
async def lifespan(app: FastAPI):
    """Inicializa watchers persistidos y los detiene al apagar."""
